...
define('text!pj',[],function () { return '{\n  "name": "terarestaurateur",\n  "version": "0.6.1",\n  "title" : "Tera-Restaurateur",\n  "description": "An awesome online multiplayer browser-based game with social elements used to showcase the power of data analytics on Teradata and IMM.",\n  "main": "index.js",\n  "scripts": {\n    "test": "make test",\n    "prestart": "node node_modules/requirejs/bin/r.js -o baseUrl=public/js mainConfigFile=public/js/main.js name=../vendor/almond/almond include=main out=public/js/main.min.js wrap=true generateSourceMaps=true optimize=uglify2 preserveLicenseComments=false",\n    "start": "node index dev"\n  },\n  "repository": {\n    "type": "git",\n    "url": "https://github.com/Svjard/TeraRestaurateur"\n  },\n  "keywords": [\n    "node.js",\n    "node",\n    "javascript",\n    "js",\n    "web",\n    "mvc",\n    "game",\n    "teradata",\n    "marketing"\n  ],\n  "author": "Marc Fisher <marc.fisher@teradata.com>",\n  "licenses": [\n    {\n      "type": "MIT",\n      "url": "http://opensource.org/licenses/MIT"\n    }\n  ],\n  "engines": {\n    "node": ">=0.10.0"\n  },\n  "dependencies": {\n    "connect" : "*",\n    "express": "*",\n    "express-partials": "*",\n    "passport": "*",\n    "passport-local" : "*",\n    "lodash": "*",\n    "async": "*",\n    "mongodb": "*",\n    "requirejs": "*",\n    "less-middleware": "*",\n    "java": "*",\n    "ejs": "*",\n    "bcrypt": "*",\n    "sockjs": "*"\n  },\n  "peerDependencies": {\n    "express": "*",\n    "nconf": "*"\n  },\n  "devDependencies": {\n    "mocha": "~1.13.0",\n    "chai": "~1.8.1",\n    "jshint": "~2.3.0",\n    "less": "~1.3.3",\n    "jade": "~0.29.0",\n    "grunt": "~0.4.1",\n    "grunt-contrib-jshint": "~0.7.0",\n    "grunt-mocha-test": "~0.7.0",\n    "grunt-contrib-clean": "~0.5.0",\n    "nconf": "~0.6.8",\n    "makara": "~0.3.0",\n    "supertest": "~0.8.1"\n  }\n}\n';});
...
define('tpl!templates/home.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<nav class="navbar navbar-default" role="navigation">\n  <!-- Brand and toggle get grouped for better mobile display -->\n  <div class="navbar-header">\n    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">\n      <span class="sr-only">Toggle navigation</span>\n      <span class="icon-bar"></span>\n      <span class="icon-bar"></span>\n      <span class="icon-bar"></span>\n    </button>\n    <a class="navbar-brand" href="#"><img src="svg/teradata-logo-h.svg" alt="Teradata Labs logo" style="height: 20px;"> Tera-Restaurteur</a>\n  </div>\n\n  <!-- Collect the nav links, forms, and other content for toggling -->\n  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n    <ul class="nav navbar-nav navbar-right">\n      <li><a href="#"><i class="fa fa-cutlery"></i> Restuarant</a></li>\n      <li><a href="#"><i class="fa fa-envelope"></i> Marketing</a></li>\n      <li><a href="#"><i class="fa fa-bullhorn"></i> Reviews</a></li>\n      <li><a href="#"><i class="fa fa-dashboard"></i> Reports</a></li>\n      <li><a href="#"><i class="fa fa-question-circle"></i> Help</a></li>\n    </ul>\n  </div><!-- /.navbar-collapse -->\n</nav>\n\n<div id="content">\n\n</div>';

}
return __p
} });
define('tpl!templates/home/dashboard.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
define(
  'views/home/Dashboard',['marionette','vent','tpl!templates/home/dashboard.tmpl'],
...
define(
  'views/Home',['marionette','vent','tpl!templates/home.tmpl',
...
define('tpl!templates/home/setup.tmpl',[],function() { return function(obj) {
obj || (obj = {});
...
((__t = ( obj.style || 'Please Choose An Option' )) == null ? '' : __t) +
' <i class="fa fa-caret-down" style="margin-right: 3px;font-size: 16px;float: right;margin-top: 3px;"></i>\n\t        </a>\n\t        <ul class="dropdown-menu" style="border-top-right-radius: 0;border-top-left-radius: 0;padding: 2px;margin-top: 34px;">\n\t            ';
 for (var i = 0; i < obj.styles.length; i++) { ;
__p += '\n\t            <li><a name="style" href="#">' +
((__t = ( obj.styles[i].name )) == null ? '' : __t) +
'</a></li>\n\t            ';
 } ;
__p += '\n\t        </ul>\n\t    </div>\n\t    <div id="styles-carousel" style="margin-top: 40px;" class="carousel slide" data-ride="carousel">\n\t        <ol class="carousel-indicators">\n\t        \t';
 for (var i = 0; i < obj.styles.length; i++) { ;
__p += '\n\t        \t<li data-target="#styles-carousel" data-slide-to="0" class="' +
...
((__t = ( (i === 0) ? 'active' : '' )) == null ? '' : __t) +
'">\n\t          \t\t<img src="images/' +
((__t = ( obj.styles[i].image )) == null ? '' : __t) +
'" style="margin: auto;opacity: 0.4;"/>\n\t          \t\t<div class="carousel-caption" style="color: rgb(245, 115, 0);padding: 0 0 15px 0;">\n\t            \t\t<h3 style="font-size: 40px;">' +
((__t = ( obj.styles[i].name )) == null ? '' : __t) +
'</h3>\n\t            \t\t<p style="font-size: 14px;text-shadow: none;color: black;">' +
((__t = ( obj.styles[i].description )) == null ? '' : __t) +
'</p>\n\t            \t</div>\n\t        \t</div>\n\t        \t';
 } ;
...
((__t = ( obj.cuisine || 'Please Choose An Option' )) == null ? '' : __t) +
' <i class="fa fa-caret-down" style="margin-right: 3px;font-size: 16px;float: right;margin-top: 3px;"></i>\n\t        </a>\n\t        <ul class="dropdown-menu" style="border-top-right-radius: 0;border-top-left-radius: 0;padding: 2px;margin-top: 34px;">\n\t            ';
 for (var i = 0; i < obj.cuisines.length; i++) { ;
__p += '\n\t            <li><a name="style" href="#">' +
((__t = ( obj.cuisines[i].name )) == null ? '' : __t) +
'</a></li>\n\t            ';
 } ;
...
define(
  'views/home/Setup',['marionette','vent','tpl!templates/home/setup.tmpl'],
...
define(
  'views/Register',['marionette','vent','tpl!templates/register.tmpl',
  ],
...
define('tpl!templates/gamedashboard.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<p>In-Game Dashboard</p>';
...
define(
  'views/GameDashboard',['marionette','vent','tpl!templates/gamedashboard.tmpl'],
...
define('tpl!templates/dbdashboard.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<p>Teradata Dashboard</p>';
...
define(
  'views/DBDashboard',['marionette','vent','tpl!templates/dbdashboard.tmpl'],
